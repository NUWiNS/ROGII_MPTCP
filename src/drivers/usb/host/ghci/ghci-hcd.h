...
#define GHCI_URB_EXT           0xd0
#define GHCI_EXT_PORT_RESET    0x00
...
#define GHCI_POWER_SUSPENDING 0x0001
#define GHCI_POWER_SUSPENDED  0x0002
#define GHCI_POWER_INACTIVE   (GHCI_POWER_SUSPENDING | GHCI_POWER_SUSPENDED)

#define GHCI_FLAG_RESET_IGNORE  (1 << 0)
